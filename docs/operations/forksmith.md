...
obligations when `upstream/main` advances, and makes validation and publication
explicit. It does not run an LLM or replace the normal provider CLIs.

## Topology

- `upstream/main` is the read-only source snapshot.
