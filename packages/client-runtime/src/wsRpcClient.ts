...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly syncCodexThread: RpcUnaryMethod<typeof WS_METHODS.serverSyncCodexThread>;
  };
...
export function createWsRpcClient(
  ...
  return {
    ...
    server: {
      ...
      syncCodexThread: (input) =>
        transport.request((client) => client[WS_METHODS.serverSyncCodexThread](input)),
    },
    orchestration: {
