  ...
  Effect.gen(function* () {
    ...
    yield* sql`
      INSERT INTO projection_thread_sessions (
        ...
        ${TEST_THREAD_ID}, 'running', 'codex', 'codex', 'session-1',
        ${TEST_PROVIDER_THREAD_ID}, 'turn-live', NULL, '2026-05-28T16:00:00.000Z', 'full-access'
      )
    `;
    yield* sql`
      INSERT INTO provider_session_runtime (
        ...
        ${TEST_THREAD_ID}, 'codex', 'codex', 'codex:session-1', 'full-access',
        'running', '2026-05-28T16:00:00.000Z',
