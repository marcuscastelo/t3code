...
import Migration0033 from "./Migrations/033_CodexImportState.ts";
import Migration0034 from "./Migrations/034_EnsureAuthAuthorizationScopes.ts";
import Migration0035 from "./Migrations/035_ProjectionThreadsWorktreeOwnership.ts";
...
export const migrationEntries = [
  ...
  [33, "CodexImportState", Migration0033],
  [34, "EnsureAuthAuthorizationScopes", Migration0034],
  [35, "ProjectionThreadsWorktreeOwnership", Migration0035],
] as const;
