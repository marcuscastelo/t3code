...
export default Effect.gen(function* () {
  ...
  const hasScopedPairingLinks =
    hasColumn(pairingLinkColumns, "scopes") && !hasColumn(pairingLinkColumns, "role");
  const hasScopedSessions =
    hasColumn(sessionColumns, "scopes") && !hasColumn(sessionColumns, "role");
